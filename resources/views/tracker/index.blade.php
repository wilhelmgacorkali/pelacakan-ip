            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div class="lg:col-span-7 space-y-4">
                    ...
                    <div class="glass-panel p-5 rounded-xl border border-indigo-500/30 bg-indigo-950/20 space-y-3">
                        ...
                        <div class="flex flex-wrap items-center gap-3 text-xs text-slate-400 pt-1">
                            ...
                            <span class="text-slate-600">•</span>
                            <span id="phoneLocationAccuracy" class="text-amber-300">Estimasi wilayah</span>
                        </div>
                    </div>
                ...
                <div class="lg:col-span-5 flex flex-col">
                    <div class="glass-panel p-4 rounded-xl flex-1 flex flex-col">
                        ...
                        <p id="phoneMapNote" class="text-[11px] text-slate-500 mt-2 text-center">
                            *Posisi pada peta adalah estimasi wilayah yang terkait dengan nomor, bukan GPS aktual perangkat.
                        </p>
                    </div>
                </div>
...
<script>
    ...
    function renderPhoneResults(data) {
        ...
        document.getElementById('phoneLocationAccuracy').innerText = data.location_accuracy || 'Estimasi wilayah — bukan GPS aktual';
        document.getElementById('phoneMapNote').innerText = data.location_source
            ? `*Sumber: ${data.location_source}. Koordinat peta adalah estimasi dan bukan GPS aktual perangkat.`
            : '*Posisi pada peta adalah estimasi wilayah yang terkait dengan nomor, bukan GPS aktual perangkat.';
