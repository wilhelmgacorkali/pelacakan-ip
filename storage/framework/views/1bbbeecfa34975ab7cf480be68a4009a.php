...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'GeoTrack & Phone Intelligence'); ?> - Sistem Pelacakan IP & No. Telepon</title>
    ...
    <header class="sticky top-0 z-50 glass-panel border-b border-slate-800/80">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                <!-- Logo & Brand -->
                <a href="<?php echo e(route('tracker.index')); ?>" class="flex items-center space-x-3 group">
                ...
                <nav class="hidden md:flex items-center space-x-1">
                    <a href="<?php echo e(route('tracker.index')); ?>" class="px-3.5 py-2 rounded-lg text-sm font-medium transition-colors <?php echo e(request()->routeIs('tracker.index') ? 'bg-indigo-600/20 text-indigo-400 border border-indigo-500/30' : 'text-slate-300 hover:text-white hover:bg-slate-800/60'); ?>">
                        <i class="fa-solid fa-crosshairs mr-1.5 text-xs"></i> Tracker Live
                    </a>
                    <a href="<?php echo e(route('tracker.history')); ?>" class="px-3.5 py-2 rounded-lg text-sm font-medium transition-colors <?php echo e(request()->routeIs('tracker.history') ? 'bg-indigo-600/20 text-indigo-400 border border-indigo-500/30' : 'text-slate-300 hover:text-white hover:bg-slate-800/60'); ?>">
                        <i class="fa-solid fa-clock-rotate-left mr-1.5 text-xs"></i> Riwayat & Export
                    </a>
                    <a href="<?php echo e(route('tracker.docs')); ?>" class="px-3.5 py-2 rounded-lg text-sm font-medium transition-colors <?php echo e(request()->routeIs('tracker.docs') ? 'bg-indigo-600/20 text-indigo-400 border border-indigo-500/30' : 'text-slate-300 hover:text-white hover:bg-slate-800/60'); ?>">
    ...
    <footer class="mt-auto border-t border-slate-800/80 bg-dark-900/60 py-6 relative z-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-400">
            ...
            <div class="flex items-center space-x-6">
                <a href="<?php echo e(route('tracker.docs')); ?>" class="hover:text-indigo-400 transition-colors">Metodologi & Batasan Teknis</a>
...
<?php /**PATH C:\IP\resources\views/layouts/app.blade.php ENDPATH**/ ?>